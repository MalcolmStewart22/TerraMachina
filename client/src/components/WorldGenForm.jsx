...
function WorldGenForm() {
    ...
    const [subdivisionLevel, setSubdivisionLevel] = useState(5);
    ...
    return (
        <div>
            ...
            <input id="subdivision" type="range" min="5" max="8" step="1" value={subdivisionLevel} onChange={e => setSubdivisionLevel(parseInt(e.target.value))} />
